...
export const SPORT_META = {
  ...
  'Equestrian':                { icon: 'ti-horse',         color: '#8e6b3d', desc: 'Dressage and equestrian events.' },
  ...
  'Wheelchair Rugby':          { icon: 'ti-ball-rugby',    color: '#34495e', desc: 'Full-contact team sport in wheelchairs.' },
  ...
  'Basketball':                { icon: 'ti-basketball',    color: '#c0392b', desc: 'Special Olympics basketball.' },
  ...
  'Tennis':                    { icon: 'ti-tennis',        color: '#16a085', desc: 'Tennis.' },
  ...
  'Unified Basketball':        { icon: 'ti-basketball',    color: '#c0392b', desc: 'Unified Sports basketball.' },
  ...
  'Unified Tennis':            { icon: 'ti-tennis',        color: '#16a085', desc: 'Unified Sports tennis.' },
  'Unified Table Tennis':      { icon: 'ti-table-tennis-bat', color: '#16a085', desc: 'Unified Sports table tennis.' },
