export const AR = {
  ...
  nav: {
    ...
    notifications:'الإشعارات', resources:'الموارد', tasks:'المهام',
    training:'التدريب', requests:'الطلبات',
    // Away page — covers both short and long label forms used in nav
    away:'خارج المقر', awayManagement:'إدارة الغياب',
  },
  pages: {
    dashboard:'لوحة التحكم', athletes:'الرياضيون', coaches:'المدربون',
    employees:'الكادر', sports:'الرياضات', events:'الفعاليات', results:'النتائج',
  ...
  dashboard: {
    ...
    away:'خارج المقر',
    awayHint:'إجازة/معسكر/منافسة',
    noSportsYet:'لم يتم تعيين رياضيين لأي رياضة بعد',
  ...
  coaches: {
    ...
    certLevel:'مستوى الشهادة', employeeNum:'رقم الكادر',
  ...
  employees: {
    ...
    employeeRole:'عضو الكادر', storeKeeper:'أمين مخزن', waiter:'نادل',
    worker:'عامل', driver:'سائق',
    employee:'عضو الكادر', designation:'المسمى الوظيفي', nationality:'الجنسية',
    gender:'الجنس', employeeNum:'رقم الكادر', qssNum:'رقم QSS',
    status:'الحالة', addEmployee:'إضافة عضو كادر',
    backToEmployees:'العودة إلى الكادر', ofEmployees:'من الكادر',
    noEmployeesMatch:'لا يوجد أعضاء كادر مطابقون', searchEmployees:'بحث في الكادر...',
  ...
  events: {
    ...
    participants:'المشاركون', status:'الحالة', addEvent:'فعالية جديدة',
    ...
    // Category system
    category:'التصنيف', allCategories:'جميع التصنيفات',
    ...
    // Approval status
    approvalStatus:'حالة الموافقة', allApprovals:'جميع حالات الموافقة',
    approved:'معتمد', tbc:'تحت المراجعة', rejected:'مرفوض',
    // Operational status
    planning:'قيد التخطيط', upcoming:'قادم', inProgress:'جارٍ',
    completed:'مكتمل', canceled:'ملغى',
    // Other fields
    ...
    technicalExpert:'خبير تقني',
    supportStaff:'طاقم الدعم',
    noEmployeesAssigned:'لا يوجد أعضاء كادر معينون',
    selectEmployee:'اختر عضو كادر',
    searchEmployee:'البحث عن موظف…',
    noMatches:'لا توجد نتائج مطابقة',
    exportPdf:'تصدير PDF',
    allSports:'كل الرياضات',
    noEligibleAthletes:'لا يوجد رياضيون مؤهلون للرياضات المحددة',
    noSearchMatches:'لا يوجد رياضيون مطابقون لبحثك',
    notInSelectedSports:'ليس ضمن الرياضة المحددة',
    searchEligible:'البحث بالاسم أو الرياضة…',
    selectSportForEligible:'اختر رياضة لهذه الفعالية لعرض الرياضيين المؤهلين',
    sportRequired:'اختر رياضة واحدة على الأقل',
    // Photo
  ...
  status: {
    ...
    retired:'متقاعد', 'on leave':'في إجازة',
    upcoming:'قادم', completed:'مكتمل', planning:'قيد التخطيط',
    'in progress':'جارٍ', inProgress:'جارٍ', 'In Progress':'جارٍ',
  ...
  profile: {
    ...
    employeeNum:'رقم الكادر', qssNumber:'رقم QSS',
    ...
    employeeInfo:'معلومات الكادر', coachInfo:'معلومات المدرب',
  },
  confirm: {
    deleteAthlete:'حذف الرياضي؟ لا يمكن التراجع عن هذا الإجراء.',
    deleteCoach:'حذف المدرب؟ سيتم إلغاء تعيين الرياضيين.',
    deleteEmployee:'حذف عضو الكادر؟ لا يمكن التراجع عن هذا الإجراء.',
  ...
  form: {
    ...
    certLevel:'مستوى الشهادة', employeeNumber:'رقم الكادر',
    startDate:'تاريخ البداية', endDate:'تاريخ النهاية',
    venue:'المكان', maxParticipants:'الحد الأقصى للمشاركين',
