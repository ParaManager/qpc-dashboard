...
const NAV_COACH = (tx) => [
  ...
  { section: tx('nav.people','People'), items: [{ id:'athletes-all', icon:'ti-run', label:tx('nav.athletes','Athletes') }, { id:'athletes', icon:'ti-run', label:tx('athletes.myAthletes','My Athletes') }] },
