    ...
    <div className="app">
      ...
      <div className="main">
        ...
        <div id="content">
          ...
          {page==='athletes-all' && isCoach && <Athletes key={`athletes-all-${refreshToken}`} athletes={athletes} coaches={coaches} employees={employees} results={results} documents={documents} events={events} registrations={registrations} onRefresh={fetchAll} onNav={goTo} initAthleteId={navState.athleteId} initStatusFilter={navState.statusFilter} navState={navState} profile={profile} />}
          {page==='coaches'   && (isAdmin || isCoach) && <Coaches   key={`coaches-${refreshToken}`} coaches={coaches} athletes={athletes} employees={employees} personDocs={personDocs} onRefresh={fetchAll} onNav={goTo} initCoachId={navState.coachId} navState={navState} profile={profile} />}
          ...
          {page==='calendar' && isCoach && <Calendar key={`calendar-${refreshToken}`} profile={profile} events={events} employees={employees} onNav={goTo} readOnly />}
