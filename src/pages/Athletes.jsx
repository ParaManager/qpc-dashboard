                          ...
                          <div key={doc.id} style={{ display:'flex', alignItems:'center', gap:10, padding:'9px 10px', background:'var(--surface2)', borderRadius:9, marginBottom:6, border:'1px solid var(--border)' }}>
                            ...
                            <div style={{ display:'flex', gap:6, flexShrink:0 }}>
                              <a href={doc.file_url} target="_blank" rel="noreferrer"
                                style={{ display:'flex', alignItems:'center', justifyContent:'center', width:28, height:28, borderRadius:7, background:'var(--surface)', border:'1px solid var(--border)', color:'var(--text2)', textDecoration:'none', fontSize:14 }} title="View">
            ...
            {list.map(a => {
              ...
              return (
                <tr key={a.id} onClick={() => setSelected(a.id)}>
                  ...
                  <td>{docCount > 0 ? <span style={{ display:'flex', alignItems:'center', gap:4, fontSize:12, color:'#0085C7', fontWeight:500 }}><i className="ti ti-files" style={{ fontSize:14 }} />{docCount}</span> : <span style={{ fontSize:12, color:'var(--text3)' }}>—</span>}</td>
